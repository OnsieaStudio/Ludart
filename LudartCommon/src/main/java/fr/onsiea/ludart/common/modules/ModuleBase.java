...
{
	private final RegistriesManager registries;
	protected boolean isWorking;

	public ModuleBase()
	{
		this.registries = new RegistriesManager();
		this.registries.atStart().add("start", () -> this.isWorking = true);
		this.registries.atStop().add("stop", () -> this.isWorking = false);
	}
}