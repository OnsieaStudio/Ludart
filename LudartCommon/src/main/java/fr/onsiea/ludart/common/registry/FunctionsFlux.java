...
@Getter
public class FunctionsFlux implements StackRelativizable<IFunction>
{
	private final Stack<IFunction> functions;

	public FunctionsFlux()
	{
		this.functions = new Stack<>();
	}

	@Override
	public final Stack<IFunction> childs()
	{
		return this.functions;
	}

	public final FunctionsFlux clear()
	{
