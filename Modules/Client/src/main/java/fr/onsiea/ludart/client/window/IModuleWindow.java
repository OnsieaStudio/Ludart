...
{
	void define(Supplier<? extends IWindowSettings> settingsIn, Supplier<? extends IWindowSystem> systemIn, Supplier<? extends IWindowRenderSystem> windowRenderSystemIn);
